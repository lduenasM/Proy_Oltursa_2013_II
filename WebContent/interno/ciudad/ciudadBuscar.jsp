...
<!--BUSCAR-->
<div class="datos">
    		  <form id="formID" name="formID" method="post" action="../../manciudad" class="form" target="_top">
              ...
              <input name="txt_accion" type="hidden" id="txt_accion" value="consultaCriterio">
                  ...
                  <tr>
                    <td colspan="3" align="center" class="tituloForm"><a href="../../manciudad" target="_parent">Listar a todos</a></td>
                  </tr>
                </table>
              </form>
          </div>     
