...
<!--REGISTRAR-->
          <div class="datos">
			<% List<Pais> datos = (List<Pais>)request.getAttribute("pais"); %>  
              <form id="formID" class="formular" method="post" action="manciudad" target="_top">
              <input name="txt_accion" type="hidden" id="txt_accion" value="registrar">
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                    <select name="txt_pais" id="txt_pais">
                     <% if(datos!=null && datos.size()>0){ int num=1;
					 for(Pais dato : datos){%>
                      <option value="<%=dato.getCod_pais()%>"><%=dato.getNom_pais()%></option>
                      <%}} %>
                    </select>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td valign="top">:</td>
                    <td valign="top">
                    <textarea name="txt_descripcion" cols="20" rows="5" class="validate[required] text-input" id="imputForm" placeholder="Descripcion" value="" type="text"></textarea>
                    </td>
                  </tr>
                  <tr>
