            ...
            <!-- CONTENIDO DERECHO-->
                <div class="contenidoDerecho">
                  ...
                  <div class="opciones" >
                    <nav>
                      <ul id="naviOpciones">
                        <li><a href="interno/pais/paisBuscar.jsp" rel="superbox[iframe][500x160]">Consultar </a></li>
                        <li><a href="interno/pais/paisRegistrar.jsp" rel="superbox[iframe][550x250]">Registrar </a></li>
                        <!-- 
                  ...
                  <!--LISTAR CONSULTAR-->
				  <% List<Pais> dato = (List<Pais>)request.getAttribute("paiss"); %>  
                    <div id="datos">
                      <form action="#" oninput="range_control_value.value = range_control.valueAsNumber">
                        ...
                        <!-- Parte que se repite-->
                        <% if(dato!=null && dato.size()>0){ int num=1;
					 for(Pais pais : dato){%>
                          <tr>
                            <td align="center"><%=num%></td>
                          <td align="center"><%=pais.getCod_pais()%></td>
                          <td align="center"><%=pais.getNom_pais()%></td>
							  <%String est=""; 
                          if (pais.getEst_pais().equals("1")){
                              est="Activado";
                          } if(pais.getEst_pais().equals("2")){
                              est="Desactivado";                    	  
                          }%>
                      	  <td align="center"><%=est%></td>
                            <td align="center">
                              <a href="manpais?txt_accion=editar&txt_id=<%=pais.getCod_pais()%>" class="button" title="Modificar"  rel="superbox[iframe][500x310]"><img src="img/icono/edit.png" width="15" height="15" style="border:none"/></a>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <a href="manpais?txt_accion=eliminar&txt_id=<%=pais.getCod_pais()%>" class="button" title="Eliminar"><img src="img/icono/cancel.png" width="15" height="15" style="border:none"/></a>
                            </td>
                          </tr>
                       <% num++;} }else{%>
                          <tr bgcolor="#CCCCCC">
